# Gera boleta-ios-instalar.png — folheto do app no iPHONE para compartilhar no WhatsApp.
# Mesmo estilo do gen-flyer-app.ps1, mas com passos de "Adicionar a Tela de Inicio" no Safari.
...
Text-C 'Controle Financeiro — App para iPhone' 372 (New-Font 25 $false) $bDim
Text-C 'INSTALE NO IPHONE (SAFARI)' 432 (New-Font 30 $true) $bText
...
$qrTmp = Join-Path $env:TEMP 'boleta-ios-qr.png'
...
$qr.Dispose()
Text-C 'Aponte a câmera do iPhone para o QR' 936 (New-Font 23 $false) $bDim

$penLine = New-Object System.Drawing.Pen($cLine, 1)
$g.DrawLine($penLine, 120, 996, 960, 996)

Text-L 'PASSO A PASSO (NO SAFARI)' 120 1018 (New-Font 27 $true) $bNeon
$fStep = New-Font 24 $false
Text-L '1.  Abra este link no Safari' 120 1070 $fStep $bText
Text-L '2.  Toque em Compartilhar (seta para cima)' 120 1114 $fStep $bText
Text-L '3.  Escolha "Adicionar à Tela de Início"' 120 1158 $fStep $bText
Text-L '4.  Toque em "Adicionar" — pronto!' 120 1202 $fStep $bPos

# aviso: precisa ser no Safari
Round 120 1268 840 96 18 $null (New-Object System.Drawing.Pen($cWarn, 2))
Text-L 'Importante: tem que ser no Safari. Se abriu pelo' 150 1286 (New-Font 22 $false) $bWarn
Text-L 'WhatsApp, toque em (•••) e "Abrir no Safari" antes.' 150 1320 (New-Font 22 $false) $bWarn

$g.DrawLine($penLine, 120, 1418, 960, 1418)
Text-C 'Grátis  •  iPhone  •  Protegido por PIN' 1442 (New-Font 22 $false) $bDim
Text-C 'Erros ou bugs?  WhatsApp (11) 93295-5199' 1498 (New-Font 23 $true) $bNeon

$out = Join-Path $root 'boleta-ios-instalar.png'
